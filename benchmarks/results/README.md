...
- `<scenario>/summary.md` is the short human-readable interpretation tied to that run's data.
...
Committed result directories are evidence, not placeholders. Regenerate them with `make benchmark`.
